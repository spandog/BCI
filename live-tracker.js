...
(function(){
  ...
  style.textContent =
    '#bci-tracker-bar{position:fixed;left:0;right:0;bottom:0;z-index:500;'+
      'background:#0f2a1a;border-top:1px solid rgba(201,168,76,0.3);'+
    ...
    '#bci-tracker-bar .bt-status{font-family:"Playfair Display",Georgia,serif;'+
      'font-size:0.62rem;letter-spacing:2px;text-transform:uppercase;font-weight:700;'+
      'color:#0f2a1a;background:#c9a84c;padding:0 14px;flex-shrink:0;'+
    ...
    '#bci-tracker-bar a.bt-link{color:inherit;text-decoration:none;flex-shrink:0;'+
      ...
      'font-family:"Playfair Display",Georgia,serif;font-size:0.6rem;letter-spacing:2px;'+
